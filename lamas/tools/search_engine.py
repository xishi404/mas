...
from lamas.tools import SearchEngineType
    ...
    def _process_extra(
        ...
        **kwargs,
        ...
        if self.engine == SearchEngineType.SERPAPI_GOOGLE:
            ...
            module = "lamas.tools.search_engine_bing"
