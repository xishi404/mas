...
from lamas.utils.ahttp_client import apost
...
TOKEN_COSTS = {
    ...
    "qwen/qwen3.5-flash": {"prompt": 0.000065, "completion": 0.00026},
    "qwen/qwen3.5-flash-02-23": {"prompt": 0.000065, "completion": 0.00026},  # $0.065/M in, $0.26/M out
    "qwen/qwen3-32b": {"prompt": 0.00008, "completion": 0.00028},  # $0.08/M in, $0.28/M out (DeepInfra)
    "qwen/qwen3.5-9b": {"prompt": 0.00005, "completion": 0.00015},  # $0.05/M in, $0.15/M out (Venice); for openrouter, end
    ...
    # Local models via vLLM (zero cost)
