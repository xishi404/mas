...
from lamas.utils.token_counter import FIREWORKS_GRADE_TOKEN_COSTS, TOKEN_COSTS
...
class CostManager(BaseModel):
    ...
    local_model: bool = False  # When True, total_cost accumulates total tokens instead of monetary cost
    ...
    def update_cost(self, prompt_tokens, completion_tokens, model):
        ...
        if self.local_model:
            # For local models, use total tokens as cost (no monetary cost)
