...
def get_metagpt_package_root():
    ...
    package_root = Path(lamas.__file__).parent.parent
...
SOURCE_ROOT = METAGPT_ROOT / "lamas"
PROMPT_PATH = SOURCE_ROOT / "prompts"
SKILL_DIRECTORY = SOURCE_ROOT / "skills"
TOOL_SCHEMA_PATH = METAGPT_ROOT / "lamas/tools/schemas"
TOOL_LIBS_PATH = METAGPT_ROOT / "lamas/tools/libs"
