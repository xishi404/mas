...
Usage:
    python3 -m lamas.actions.write_docstring <filename> [--overwrite] [--style=<docstring_style>]
...
Example:
    python3 -m lamas.actions.write_docstring ./metagpt/software_company.py --overwrite False --style=numpy
...
from lamas.utils.common import OutputParser, aread, awrite
from lamas.utils.pycst import merge_docstring
