...
from lamas.configs.browser_config import BrowserConfig
from lamas.configs.embedding_config import EmbeddingConfig
from lamas.configs.file_parser_config import OmniParseConfig
from lamas.configs.llm_config import LLMConfig, LLMType
from lamas.configs.mermaid_config import MermaidConfig
from lamas.configs.redis_config import RedisConfig
from lamas.configs.s3_config import S3Config
from lamas.configs.search_config import SearchConfig
from lamas.configs.workspace_config import WorkspaceConfig
from lamas.const import CONFIG_ROOT, METAGPT_ROOT
...
class Config(CLIParams, YamlModel):
    ...
    def from_home(cls, path):
        """Load config from ~/.lamas/config2.yaml"""
