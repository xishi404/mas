...
import maas.ext.maas.scripts.optimized.MATH.test.template.prompt_short as prompt_short
import maas.ext.maas.scripts.optimized.MATH.test.template.operator as operator
import maas.ext.maas.scripts.optimized.MATH.test.template.op_prompt_short as op_prompt_short
...
from maas.ext.maas.scripts.optimized.scheduler import schedule, GENERATORS
