...
import maas.ext.maas.scripts.optimized.MATH.train.template.prompt_short as prompt_short
import maas.ext.maas.scripts.optimized.MATH.train.template.operator as operator
import maas.ext.maas.scripts.optimized.MATH.train.template.op_prompt_short as op_prompt_short
