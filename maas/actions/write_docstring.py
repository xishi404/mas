...
Usage:
    python3 -m maas.actions.write_docstring <filename> [--overwrite] [--style=<docstring_style>]
...
Example:
    python3 -m maas.actions.write_docstring ./metagpt/software_company.py --overwrite False --style=numpy
...
from maas.utils.common import OutputParser, aread, awrite
from maas.utils.pycst import merge_docstring
